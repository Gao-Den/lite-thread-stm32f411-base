...
typedef void (*pf_log_flash_write_prewrite)();
...
extern void lt_log_init(pf_log_flash_read flash_read, pf_log_flash_write flash_write, pf_log_flash_write_prewrite flash_write_pre, uint32_t log_address);
extern void lt_fatal_log(const char* type, uint8_t id);
